...
service StudentService {
    Response addStudent(1: SaveStudentReq request) (api.post="/add-student-info", api.baseurl = 'example.com');
    Response queryStudent(1: QueryStudentReq request) (api.get="/query", api.baseurl = 'example.com');
//    Response queryStudent2(1: QueryStudentReq request) (api.get="/query2", api.baseurl = 'example.com');
}
